...
sample_characteristics_ = SampleCharacteristics(rate=rate_, codec=codec_, width=750, height=576, anamorphic='FALSE',
...
sample_characteristics_ = SampleCharacteristics(rate=rate_, width=750, height=576, anamorphic='FALSE', pixelaspectratio='square',
                           fielddominance='none')
...
text_file = open("output_main_00.xml", "w")
