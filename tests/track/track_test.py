from fcpxml import SampleCharacteristics, Rate, Video, Audio, Media, File, ClipItem, Link, Track
...
clipitems_ = {'clipitem-1': clpitm}
trck = Track(clipitems=clipitems_, enabled='TRUE', locked='FALSE')

trck_node = trck.make_node()
root.append(trck_node)
